...
prod <- fread("/home/mallick/Desktop/Nielsen/Data/CleanComScore/prod.csv")

getPurch <- function(yr) {
  print(yr)
  trips <- fread(paste0("/home/mallick/Desktop/Nielsen/Data/CleanComScore/Trips/trips", yr, ".csv"),
                 select = c("trip_code_uc", "purchase_date", "household_code", "panel_year"),
                 key = "trip_code_uc")
  purch <- fread(paste0(path, yr, "/Annual_Files/purchases_", yr, ".tsv"), key = "trip_code_uc")
  ...
  fwrite(purch, paste0("/home/mallick/Desktop/Nielsen/Data/CleanComScore/Purchases/purchase", yr, ".csv"))
}
walk(yr, getPurch)
