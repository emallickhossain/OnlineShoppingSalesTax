...
panel <- fread("/home/mallick/Desktop/Nielsen/Data/CleanComScore/fullPanel.csv",
...
getTrips <- function(yr) {
  ...
  fwrite(trips, paste0("/home/mallick/Desktop/Nielsen/Data/CleanComScore/Trips/trips", yr, ".csv"))
}
map(yr, getTrips)
